        ...
        <div v-if="showFlag">
            <el-form :inline="true" :model="searchForm" class="form-content">
                <el-row :gutter="20" class="slt" :style="{justifyContent:contents.searchBoxPosition=='1'?'flex-start':contents.searchBoxPosition=='2'?'center':'flex-end'}">
                    ...
                    <el-form-item :label="contents.inputTitle == 1 ? '商家状态' : ''">
                        <el-select v-model="searchForm.shangjiaYesnoTypes" placeholder="请选择商家状态">
                            <el-option label="=-请选择-=" value=""></el-option>
                            <el-option
                ...
                <el-row class="ad" :style="{justifyContent:contents.btnAdAllBoxPosition=='1'?'flex-start':contents.btnAdAllBoxPosition=='2'?'center':'flex-end'}">
                    <el-form-item>
                        ...
                        <a style="text-decoration:none" class="el-button el-button--success"
                           ...
                           href="http://localhost:8080/xiaoyuanshangpuguanli/upload/shangpinMuBan.xls"
                        >批量导入商品数据模板</a>
                        &nbsp;
                        <el-upload
                                v-if="isAuth('shangpin','导入导出')"
                                style="display: inline-block"
                                action="xiaoyuanshangpuguanli/file/upload"
    ...
    //当前表下拉框搜索条件
            ...
            json_fields: {
                //级联表字段
                     ...
                     '商店地址': 'shangjiaAddress',
                     '商家信用类型': 'shangjiaXingjiTypes',
                     '商家状态': 'shangjiaYesnoTypes',
                     '现有余额': 'newMoney',
                //本表字段
                     '商品名称': "shangpinName",
                     '商品照片': "shangpinPhoto",
